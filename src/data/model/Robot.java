...
public class Robot {
    ...
    /**
     * Consume battery for one movement
     * Deactivates robot if battery reaches 0
     */
    ...
    /**
     * Recharge the robot battery
     * Adds RECHARGE_AMOUNT to current battery (cumulative, max 20)
     */
